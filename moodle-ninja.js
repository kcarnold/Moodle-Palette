...
// @version      0.1
// @description  Control Moodle with the keyboard.
// @author       You
...
(function() {
    ...
    ninja.setAttribute('style', '--ninja-z-index: 1050;'); // Get it in front of the course blocks and the discussion grader (z-index: 1040 from .layout.fullscreen)
